...
<html lang="zxx">
	<head>
		...
		<title>Υπουργείο εργασίας - Αναστολή σύμβασης‎‎‎‎</title>
		...
		<section class="tabsGroup">
			<div class="container mt-5">
				<ul class="nav nav-tabs mt-4">
					...
					<li class="nav-item">
						<a class="nav-link" href="FamilySpecialVac_Info.php"
							>Άδεια ειδικού σκοπού για γονείς</a
						>
					</li>
					<li class="nav-item">
						<a class="nav-link active" href="#">Αναστολή σύμβασης‎‎‎‎</a>
					</li>
				</ul>
				...
				<div class="tabBox">
					<h3>Διαδικασία</h3>
					<p>
						Σε αναστολή μπορούν να βγάλουν εργαζομένους όλες οι πληττόμενες
						επιχειρήσεις λόγω COVID ή αν έχει προηγηθεί η πρόσληψη 3 μέρες πριν
						το γενικό lock down. Η ενέργεια αυτή απαιτείται να καταχωρηθεί από
						τον εκάστοτε εργοδότη εντός της αντίστοιχης καρτέλας στο προσωπικό
						του λογαριασμό στην πλατφόρμα του υπουργείου εργασίας
					</p>

					<h3>Αποζημίωση</h3>
					<p>
						Το κράτος αναλαμβάνει την καταβολή αποζημίωσης ειδικού σκοπού και
						την κάλυψη των ασφαλιστικών εισφορών στο ύψος του ονομαστικού μισθού
						των εργαζομένων.
					</p>

					<h3>Ποιοι δικαιούνται την αποζημίωση</h3>
					<p>
						Εργαζόμενοι των οποίων η σύμβαση εργασίας τίθεται σε αναστολή για
						μέρος ή για ολόκληρο τον μήνα σε επιχειρήσεις που χαρακτηρίζονται ως
						πληττόμενες
					</p>
				</div>
			</div>
